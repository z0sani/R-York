...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/swarmie/RMC/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/swarmie/RMC/devel/.private/rosserial_windows)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/swarmie/RMC/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/swarmie/RMC/src/rosserial/rosserial_windows/${idir}'.  Ask the maintainer 'Kareem Shehata <kshehata@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/swarmie/RMC/devel/.private/rosserial_windows/lib;/home/swarmie/RMC/devel/lib;/opt/ros/kinetic/lib)
